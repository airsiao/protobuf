...
package com.netease.protobuf {
	...
	public class Message {
		 ...
		 */
		public final function mergeFrom(input:IDataInput, charset:String="UTF-8"):void {
		 ...
		 */
		public final function mergeDelimitedFrom(input:IDataInput, charset:String="UTF-8"):void {
			Message.Charset = charset
			input.endian = flash.utils.Endian.LITTLE_ENDIAN
		 ...
		 * @see #writeDelimitedTo()
		 */
		public final function writeTo(output:IDataOutput, charset:String="UTF-8"):void {
			Message.Charset = charset;
		 ...
		 */
		public final function writeDelimitedTo(output:IDataOutput, charset:String="UTF-8"):void {
			Message.Charset = charset;
			const buffer:com.netease.protobuf.WritingBuffer = new com.netease.protobuf.WritingBuffer()
